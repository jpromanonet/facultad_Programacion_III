...
namespace Snake
{
    public partial class Snake : UserControl, IMessageFilter
    {
        ...
        private void DareBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    lbl_Game.Text = "¡¿Como te ateves a no escuchar?!";
                    break;
                case 1:
                    lbl_Game.Text = "Estas en un camino oscuro...";
                    break;
                case 2:
                    lbl_Game.Text = "¡Sabia que no ibas a escuchar!";
                    break;
                case 3:
                    lbl_Game.Text = "Toma algo de comida!!!!!!!!!!!  :)";
